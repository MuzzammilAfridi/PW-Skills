  ...
  return (
    ...
    <div className='bg-[#5A4BDA] text-white flex flex-col gap-10 sm:flex-row '>
        <div className="w-[80vw] sm:mt-14 sm:h-screen mt-5">
            <div className=" flex flex-col sm:mt-16 items-center gap-6 mb-10 justify-center pl-5 sm:items-start">
            <h3 className='text-center text-3xl px-5 sm:w-[35vw]  font-semibold py-4 sm:text-start sm:text-5xl'>Attain financial freedom by joining our affiliate program</h3>
            <button className=' w-60 py-3 rounded-xl sm:ml-4 bg-[#EDB84F] text-2xl text-black font-semibold'>Register with us</button>
            </div>
        </div>
